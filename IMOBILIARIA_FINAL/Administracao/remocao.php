...
?>
      ...
      <p>
        ...
        <input style="padding:10px;border:1px solid white;border-radius: 10px;background-color:rgb(23,173,170);color:white;margin:20px;" type="submit" name="acao" value="Remover">
      </p>
    </form>
            <center>
