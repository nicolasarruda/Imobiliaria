...
<body>
    <header class = "header-1">
        <div class= "info">
        <ul>
            <li><img src="html\imagens\celularbranco.png"></li>
            <li><p>(11) 9 1234-5678</p></li>
            <li><img src="html\imagens\telefonebranco.png"></li>
            <li><p>(11) 4567-8901</p></li>
            <li style = "margin-left: 550px;"><a>|</a></li>
            <li><img src="html\imagens\instagram.png"></li>
            <li style = "font-size: 20px;"><p>imorelapsos</p></li>
            <li><img src="html\imagens\facebook.png"></li>
            <li style = "font-size: 20px;"><p>imorelapsos</p></li>
            <li style = "margin-left: 60px;"><a href = "index.php"><img src="html\imagens\perfil.png"></a></li>
            <li style = "font-size: 20px;font-weight: bold;"><a href="index.php">Login</a></li>
    </ul>
    </div>
    </header>
    <div class = "header-2">
...
<div class ="img-1">
    <img src="html\imagens\imagem1.png">
    </div>
</body>
