...
<html lang="pt-br">
    ...
    <body> 
        <nav class ="navbar">
            ...
            <p class = "primeiro-parag">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nesse site é possível gerenciar várias opções sobre a imobiliária. Dentre elas estão a consulta de clientes, cadastro de clientes, cadastro de imóveis e etc. Espero que use site com sabedoria.</p>
